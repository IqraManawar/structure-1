   ...
   return(
        <div>
            ...
            <div className="absolute w-[1170px] h-[435px] left-[135px] top-[353px]" />
                ...
                <Image src="/sample1.png" alt="Project Image1" width={670} height={435} className="absolute w-[670px] h-[435px] left-[135px] top-[353px]"/>
                ...
                <button type="button" className="absolute w-[222px] h-[71px] left-[835px] top-[687px] bg-[#FFFFFF] flex items-center justify-center font-['Roboto'] not-italic text-[14px] text-[#000000]" onClick={()=>router.push('/sam')} >View More →</button>
            ...
            <div className="absolute w-[1170px] h-[435px] left-[135px] top-[848px]"/>
                ...
                <Image src="/sample2.png" alt="Project Image2" width={670} height={435} className="absolute w-[670px] h-[435px] left-[135px] top-[848px]"/>
            ...
            <div className="absolute w-[1170px] h-[435px] left-[135px] top-[1343px]"/>
                <Image src="/sample3.png" alt="Project Image3" width={670} height={435} className="absolute w-[670px] h-[435px] left-[135px] top-[1343px]"/>
