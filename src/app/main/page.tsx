...
export default function Main(){
    ...
    return(
        <div className="max-w-[100%] overflow-hidden">
            ...
            <div>
                <Image src="/main.png" alt="Building image" width={770} height={829} className="absolute w-[770px] h-[829px] left-[535px] top-[105px] "/>
                <div className="absolute w-[221.81px] h-[71px] left-[534.66px] top-[863px] bg-[#FFFFFF] pl-7 pt-7">
                    <button className="flex text-center items-center left-[20.34px] top-[24px] w-[152px] h-[24] space-[18px] text-[#333333] font-['Roboto'] not-italic text-[12px] leading-[12px] uppercase" onClick={()=>router.push('/project')}>View projects →</button>
                </div>
            </div>
        </div>
