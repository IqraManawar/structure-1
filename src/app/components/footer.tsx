    ...
    return(
        <div className="absolute w-[100%] h-[417px] left-0 top-[3635px] bg-[#2C2C2C]">
            <div className="flex justify-center md:justify-start">
                <Image src="/logo1.png" alt="logo" loading="lazy" width={145} height={94} decoding="async" data-nimg="1" className="absolute w-[145px] h-[94px] left-[116px] top-[58px]"/>
            </div>
            ...
            <div className="absolute left-[43.06%] top-[13.91%] bottom-[81.29%] font-['Roboto'] not-italic text-white text-center md:text-left space-y-6 flex flex-col gap-5">
                <div>
                    ...
                    <div className="mt-2 flex justify-center md:justify-start">
                        ...
                        width={11}
                        height={16} className="w-[11] h-[16] viewBox-[0 0 11 16] fill-none mr-2"/>
                    ...
                    <div className="flex item-center justify-center md:justify-start">
                        ...
                        width={11}
                        height={16} className="w-[11] h-[16] viewBox-[0 0 11 16] fill-none mr-2"/><p>512.333.2222</p>
                    </div><br/>
                    <div className="flex item-center justify-center md:justify-start">
                        <Image src="/email.png" alt="" className="w-[11] h-[16] viewBox-[0 0 11 16] fill-none mr-2"
                        width={11} height={16}/><p>sampleemail.com</p>
                    </div>
            ...
            <div className="absolute w-[193px] h-[64px] right-[212px] top-[58px]">
                ...
                <div className="w-[186] h-[21] viewBox-[0 0 186 21] fill-[none] absolute left-0 top-[80%] gap-5 flex">
                    <a href="#"><Image src="/twitter.png" alt="twitter" width={11} height={16}/></a>
                    <a href="#"><Image src="/facebook.png" alt="facebook" width={11}
                    height={16}/></a>
                    <a href="#"><Image src="/linkin.png" alt="linkin" width={11} height={16}/></a>
                    <a href="#"><Image src="/pininterest.png" alt="pininterest" width={11} height={16}/></a>
                </div>
            </div>
